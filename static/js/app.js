  ...
  var data = [
    {
      ...
      gauge: {
        ...
        steps: [
            ...
            { range: [0, 1], color: "rgb(240, 248, 255)" }, 
            { range: [1, 2], color: "rgb(173, 216, 230)" },
            { range: [2, 3], color: "rgb(135, 206, 250)" }, 
            { range: [3, 4], color: "rgb(100, 149, 237)" }, 
            { range: [4, 5], color: "rgb(70, 130, 180)" },  
            { range: [5, 6], color: "rgb(30, 144, 255)" },  
            { range: [6, 7], color: "rgb(0, 105, 148)" },   
            { range: [7, 8], color: "rgb(0, 75, 135)" },   
            { range: [8, 9], color: "rgb(0, 49, 82)" }    
